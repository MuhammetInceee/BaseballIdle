...
public class BaseballPlayerUpgrade : MonoBehaviour
{
    ...
    private BaseballPlayerMain MainComponent => transform.parent.transform.parent.GetComponent<BaseballPlayerMain>();
    private void Awake()
    {
